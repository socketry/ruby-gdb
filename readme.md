...
Please see the [project documentation](https://socketry.github.io/toolbox/) for more details.
  ...
  - [Object Inspection](https://socketry.github.io/toolbox/guides/object-inspection/index) - This guide explains how to use `rb-inspect` to inspect Ruby objects, hashes, arrays, and structs in GDB.
